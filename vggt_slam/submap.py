...
class Submap:
    def __init__(self, submap_id):
        ...
        self.metric_scale = None            # EXP-12 metric-anchor ratio dict (opt-in; else None)
        self.metric_anchor_untrusted = False  # set when the anchor disagreed with rich-overlap geometry
